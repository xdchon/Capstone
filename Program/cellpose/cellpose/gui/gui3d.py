...
class MainW_3d(MainW):
    ...
    def __init__(self, image=None, logger=None):
        ...
        # time scrollbar underneath (for TCZYX)
        self.timeScrollBottom = QScrollBar(QtCore.Qt.Horizontal)
        self.timeScrollBottom.setMaximum(0)
        self.timeScrollBottom.valueChanged.connect(self.move_in_T)
        self.timeScrollBottom.hide()
        self.lmain.addWidget(self.timeScrollBottom, 41, 9, 1, 30)
    ...
    def move_in_T(self, value):
        if hasattr(self, "timeScrollBottom"):
            self.timeScrollTop.setValue(value)
        super().move_in_T(value)
